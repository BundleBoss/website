...
description: A guided, step-by-step way to create a WooCommerce bundle. Pick what you are making, add products, preview, and publish.
permalink: /docs/wizard/
lede: Pick what you are making, add your products, see a live preview, and publish. The wizard builds an ordinary bundle you can still edit by hand.
---
...
- **The wizard creates; the editor edits.** To change a bundle later, open it in the [full editor](/docs/getting-started/). Everything the wizard set is right there, ready to adjust.
