...
description: Discount the cheapest items a customer adds to a bundle. Buy one get one free, buy 2 get 1 free, any 6 for the price of 4. It prices what they actually select, so it pairs with build a box and the quantity grid.
permalink: /docs/bogo/
...
Because it prices what the customer actually selects, it is a perfect match for [build a box](/docs/build-a-box/) and the [quantity grid](/docs/quantity-grid/): "build your own 6 pack, the cheapest 2 are free."

## Turn it on

On a bundle, open the **Bundle Promotions** tab, switch on the **Buy X, get Y** row and click **Edit**:
